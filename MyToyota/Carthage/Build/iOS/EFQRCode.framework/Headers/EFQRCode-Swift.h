...
SWIFT_MODULE_NAMESPACE_PUSH("EFQRCode")




typedef SWIFT_ENUM(NSInteger, EFInputCorrectionLevel) {
...
typedef SWIFT_ENUM(NSInteger, EFPointShape) {
...
typedef SWIFT_ENUM(NSInteger, EFQRCodeMode) {
  EFQRCodeModeNone = 0,
...
typedef SWIFT_ENUM(NSInteger, EFWatermarkMode) {
